...
for file in src/*; do FNAME=$(basename ${file}); echo "copying file ${FNAME}"; cp -f 
${WCSIMDIR}/src/${FNAME} ./src/; done
for file in include/*; do FNAME=$(basename ${file}); echo "copying file ${FNAME}"; cp -f 
${WCSIMDIR}/include/${FNAME} ./include/; done
