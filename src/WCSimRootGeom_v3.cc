...
ClassImp(WCSimRootGeom_v3)
#endif

UInt_t WCSimRootGeom_v3::GetCheckSum(){ return 1131018360; }

//______________________________________________________________________________
WCSimRootGeom_v3::WCSimRootGeom_v3()
{
  // Create a WCSimRootGeom_v3 object.
  fWCNumPMT = 0;
  fPMTArray = 0;
...
//______________________________________________________________________________
void WCSimRootGeom_v3::SetPMT(Int_t i, Int_t tubeno, Int_t cyl_loc, 
...
void WCSimRootGeom_v3::SetLAPPD(Int_t i, Int_t lappdno, Int_t cyl_loc, 
			    Float_t rot[3], Float_t pos[3], std::string PmtType, bool expand)
{
