#ifndef WCSim_LAPPDInfo
#define WCSim_LAPPDInfo
...
public: 
  ...
  WCSimLAPPDInfo(Int_t i, Double_t t1, Double_t t2, Double_t t3, Double_t o1, Double_t o2, Double_t o3, Int_t lappdid);
  
  virtual ~WCSimLAPPDInfo();
